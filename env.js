 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.sheba.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.sheba'; // ios bundle id
const PACKAGE = 'com.sheba'; // android package name
const NAME = 'sheba'; // app name
const EXPO_ACCOUNT_OWNER = 'software.developer.yamin'; // expo account owner
const EAS_PROJECT_ID = '03e0bfb9-5b73-4734-9227-678296d96e1a'; // eas project id
const SCHEME = 'sheba'; // app scheme
const SLUG = 'sheba'; // app name
